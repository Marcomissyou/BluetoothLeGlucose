...
public class BluetoothLeService extends Service {
    ...
    public final static String EXTRA_DATE = "com.example.bluetooth.le.EXTRA_DATE";
    public final static String SEQUENCENUMBER = "com.example.bluetooth.le.EXTRA_SEQUENCENUMBER";
    public final static String GLU_FEATURE = "com.example.bluetooth.le.GLU_FEATURE";

    public final static UUID UUID_GLUCOSE_SERVICE =UUID.fromString(SampleGattAttributes.GLUCOSE_SERVICE);
    public final static UUID UUID_BATTERY_SERVICE =UUID.fromString(SampleGattAttributes.BATTERY_SERVICE);
    public final static UUID UUID_GLUCOSE_MEASUREMENT = UUID.fromString(SampleGattAttributes.GLUCOSE_MEASUREMENT_VALUE);
    public final static UUID UUID_GLUCOSE_FEATURE = UUID.fromString(SampleGattAttributes.GLUCOSE_FEATURE);
    public final static UUID UUID_GLUCOSE_CONTROL_POINT = UUID.fromString(SampleGattAttributes.GLUCOSE_CONTROL_POINT);
    ...
    private void broadcastUpdate(final String action,
        ...
        if (UUID_GLUCOSE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            int Minutes =  characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 8);
            int Seconds = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT8, 9);
            int a = characteristic.getProperties();
            Log.d(TAG, String.format("Glu Feature Characteristic Property : %d", a));
            int glucoseValue = characteristic.getIntValue(BluetoothGattCharacteristic.FORMAT_UINT16, 10);
            ...
            Log.d(TAG, String.format("Glucose Feature: %d", GluFeatureValue));
            intent.putExtra(GLU_FEATURE, String.valueOf(GluFeatureValue));
        } else {
    ...
    /* This Internal Binder class is used obtain service. */
    ...
    public boolean readCharacteristic(UUID CharacteristicUUID) {
        ...
        BluetoothGattService Service = mBluetoothGatt.getService(UUID_GLUCOSE_SERVICE);
        if (Service == null) {
    ...
    public boolean writeCharacteristic(String value) {
        ...
        BluetoothGattCharacteristic characteristic = Service.getCharacteristic(UUID_GLUCOSE_CONTROL_POINT);
        if (characteristic == null) {
        ...
        int a = characteristic.getProperties();
        Log.d(TAG, String.format("Characteristic Property : %d", a));
